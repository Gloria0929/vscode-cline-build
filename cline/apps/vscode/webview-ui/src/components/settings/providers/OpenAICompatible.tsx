...
export const OpenAICompatibleProvider = ({
	...
	return (
		<div>
			<Tooltip>
				{/* The trigger renders a shrink-to-fit <button>; without w-full the
				    inner width:100% has no definite parent width and the 接口地址
				    field collapses to its intrinsic width. */}
			...
			{remoteConfigSettings?.azureApiVersion !== undefined ? (
				<Tooltip>
					...
					<TooltipContent>此设置由您组织的远程配置管理</TooltipContent>
				</Tooltip>
			) : (
				<BaseUrlField
					initialValue={apiConfiguration?.azureApiVersion}
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						...
						<div style={{ flex: 1 }}>
							<DebouncedTextField
								...
								onChange={(value) => updateNumericModelOverride("maxTokens", "最大输出 Token", value)}
								placeholder="未设置">
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<div style={{ flex: 1 }}>
							<DebouncedTextField
								...
								onChange={(value) =>
									updateNumericModelOverride("inputPrice", "输入价格，单位：美元 / 百万", value)
								}>
								<span style={{ fontWeight: 500 }}>输入价格 / 百万 token</span>
							</DebouncedTextField>
						...
						<div style={{ flex: 1 }}>
							<DebouncedTextField
								...
								onChange={(value) =>
									updateNumericModelOverride("outputPrice", "输出价格，单位：美元 / 百万", value)
								}>
								<span style={{ fontWeight: 500 }}>输出价格 / 百万 token</span>
							</DebouncedTextField>
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>注意：</span>Coder
					使用复杂提示词，因此行为可能因模型而异。能力较弱的模型可能无法如预期工作。)
				</span>
			</p>
...
// -1 is the legacy UI sentinel for "未设置"; it renders (and compares) as unset.
