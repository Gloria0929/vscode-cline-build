	...
	return (
		<div className="flex flex-col gap-1.5">
			<DebouncedTextField
				...
				placeholder="请输入 AI Core 客户端 ID..."
					style={{ width: "100%" }}
					type="password">
							...
							<>
								{sapAiCoreModelDeployments.length === 0 && (
									<div className="text-xs text-(--vscode-errorForeground) mb-2">
										无法从 SAP AI Core 服务实例获取模型。请检查您的 SAP AI Core 配置，或确保您的部署已在服务实例中部署并运行
									</div>
								)}
