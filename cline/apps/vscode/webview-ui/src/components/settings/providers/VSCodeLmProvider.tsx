			...
			<DropdownContainer
				...
				{vsCodeLmModels.length > 0 ? (
					...
					<p
						...
						通过 VS Code 语言模型 API 使用其他扩展提供的模型。最常见的来源是 GitHub Copilot — 请安装{" "}
						<a href="https://marketplace.visualstudio.com/items?itemName=GitHub.copilot">Copilot 扩展</a>{" "}
						并在 Copilot 设置中启用模型；任何注册了语言模型提供商的扩展都会显示在这里。{" "}
						<VSCodeLink
