		...
		<div className="flex flex-col gap-2">
			...
			<div className="text-xs text-description">
				借助 LM Studio，您可以在本地计算机上运行模型。如需说明请参阅其
					...
					功能（使用 <code>lms server start</code>）才能在此扩展中使用。{" "}
					<div className="text-error">
						<span className="font-semibold">注意：</span>Coder 使用复杂提示词，因此行为可能因模型而异。能力较弱的模型可能无法如预期工作。
					</div>
			</div>
		</div>
	)
