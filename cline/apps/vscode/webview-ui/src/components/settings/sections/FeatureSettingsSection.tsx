...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "功能提示",
		description: "Show rotating tips during the thinking phase to help you discover Coder features.",
	...
	},
	{
		id: "worktrees",
		label: "工作树",
		description: "启用 git 工作树管理，支持并行运行 Coder 任务。",
					...
					<div>
						...
						<div
							...
							<div className="space-y-2 py-3">
								<Label className="text-sm font-medium text-foreground">自动压缩 Strategy</Label>
