...
/**
 * Grace period before showing the "思考中..." loader row when its trigger is the tail
 ...
 * "思考中..." loader row should be requested. This is the sole early loading indicator -
...
/**
 * Debounced visibility for the in-list "思考中..." loader row.
 *
...
/**
 * Whether the in-list "思考中..." loader row should currently be rendered.
