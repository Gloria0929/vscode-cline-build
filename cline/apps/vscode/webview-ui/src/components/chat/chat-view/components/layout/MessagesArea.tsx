...
// Sentinel ts for the synthetic "思考中..." placeholder row. Not a real message; ignored when
...
export const MessagesArea: React.FC<MessagesAreaProps> = ({
	...
	// (idle/completed/awaiting_*). Let the loader show optimistically so "思考中..." renders
	...
	// frames to measure and paint its first item, which visibly delays the "思考中..." shimmer
