 ...
 * CLI or from another workspace). Coder reads, edits, and runs commands in
	...
	return (
		<Tooltip>
			<TooltipContent className="max-w-xs" side="bottom">
				This task's working directory is {cwd}, which is outside the current workspace. Coder reads and edits files and
				runs commands there.
			</TooltipContent>
