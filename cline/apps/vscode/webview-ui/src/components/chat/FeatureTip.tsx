...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: "Add a .clinerules file to your project root to give Coder project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Coder takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Coder access to external tools and APIs.",
	},
	{
		text: "Coder creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
		text: "Use /compact to condense long conversations and free up context window space.",
	},
	{
		text: "为读取文件这类只读工具启用自动批准，可加快探索速度。",
	},
	{
		text: "Use the quote button to select text from Coder's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Coder.",
	},
	{
...
/**
 * Shows rotating feature tips below the "思考中..." indicator.
 * Appears after a brief delay and cycles through tips while Coder is thinking.
 */
