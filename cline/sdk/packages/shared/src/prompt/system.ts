export const DEFAULT_CLINE_SYSTEM_PROMPT = `You are Coder, an AI coding agent. Your primary goal is to assist users with various coding tasks by leveraging your knowledge and the tools at your disposal. Given the user's prompt, you should use the tools available to you to answer user's question.
...
export const YOLO_CLINE_SYSTEM_PROMPT = `You are Coder, a careful and helpful coding agent that works in the background.
